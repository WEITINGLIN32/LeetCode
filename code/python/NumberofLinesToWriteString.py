'''
Title: 806. Number of Lines To Write String (Easy) https://leetcode.com/problems/number-of-lines-to-write-string/

Runtime: 20 ms, faster than 85.39% of Python online submissions for Number of Lines To Write String.
Memory Usage: 11.8 MB, less than 5.72% of Python online submissions for Number of Lines To Write String.
